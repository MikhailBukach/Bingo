...
i_img_name = 'camera/history/camera02.jpg'
    ...
    for i in xrange(maximum):
        ...
        if pos.size != 0:
            ...
            if hull_area >= min_hull_area and hull_area <= max_hull_area and w >= 30 and h >= 30:
                ...
                im_rotated_name = images_folder + "im_crop_rotated_" + str(i) + ".jpg"
                ...
                if rotate_image_clockwize:
                    for index in range(len(degrees)):
                        new_im_name = images_folder + "im_rotated_to_" + str(degrees[index]) + "_" + str(i) + ".jpg"
